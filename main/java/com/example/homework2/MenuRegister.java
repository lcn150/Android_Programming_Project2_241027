...
public class MenuRegister extends AppCompatActivity {
    ...
    private void dispatchTakePictureIntent() {   //카메라 앱을 실행하기위한 요청
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (Menu_mPhotoFile !=null) {
                ...
                Uri imageUri = FileProvider.getUriForFile(this, "com.example.homework2", Menu_mPhotoFile);
    ...
    private void insertMenuRecord() { //메인에서 삽입역할
        String imageuri2 = "sdcard/Android/data/com.example.homework2/files/Pictures/"+ Menu_PhotoFileName;
